...
const StudentAssessment = lazy(() =>
  import("../pages/faculty/StudentAssessment")
);
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="flex items-center space-x-3 w-full p-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
          >
